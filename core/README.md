...
A reusable task management system for AI assistants (Gemini, GPT, etc.) with intelligent deduplication and organization.
...
Copy `GEMINI_TEMPLATE.md` to `GEMINI.md` and customize:
...
```
"Read GEMINI.md for instructions on managing my tasks"
```
...
├── GEMINI.md              # AI instructions (from template)
...
- **Workflows**: Modify GEMINI.md instructions
...
Built for use with AI assistants like Gemini, GPT, and others that support tool calling.