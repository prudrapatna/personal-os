...
if [ ! -f "GEMINI.md" ] && [ -f "core/templates/GEMINI.md" ]; then
    cp "core/templates/GEMINI.md" "GEMINI.md"
    print_success "Copied: GEMINI.md"
else
    print_info "File exists: GEMINI.md (preserving your version)"
fi
...
echo "2. Read GEMINI.md to understand how your AI agent works"
echo "3. Start adding tasks or notes to BACKLOG.md"
echo "4. Tell your AI: 'Read GEMINI.md and help me process my backlog'"
echo ""
